# -*- coding: utf-8 -*-
"""
Created on Mon Apr  8 20:19:42 2019
...
class email_pdf:       
    def email_pdf(self,filepath,fromaddr,user):
        list=pd.read_excel('E:\\Tableaupdfemail\\LIST.xlsx',index=False)
        #a=list['Country'].unique
        list_user=list[list['EMAIL']==user]
        #filelist=[]
        subprocess.call(r'E:\Tableaupdfemail\login.bat')
        for index,row in  list_user.iterrows():
            ...
            file = open("E:\\Tableaupdfemail\\test.bat","w")
            ...
            try:
                ...
                subprocess.call(r'E:\Tableaupdfemail\test.bat')
...
if __name__ == '__main__':
    filepath='E:\\Tableaupdfemail\\LIST.xlsx' #file path
    fromaddr='admin@domain.com'
